...
const Home = (place='top', data={}, traps={}) => {
    ...
    part.toggle('#title', 'titleText', 'Enjoy your stay', 'Welcome to CleanJS');
    on('click', elt('title'), _=> now._activeParts = ['remove', 'Footer']);
    on('click', elt('lowerSvg'), _=> now._activeParts = ['add', 'Footer', 'ChangeStateButton']);
                                ...
                                const part = new Part(partElt.id, now, place, homeContent, script, stateInit, trapsInit);
...
const ChangeStateButton = (place='top', data={}, traps={}) => {
    ...
    // store.link('text', [btn, 'textContent']);
                                ...
                                const part = new Part(partElt.id, now, place, changeStateButtonContent, script, stateInit, trapsInit);
...
const Footer = (place='top', data={}, traps={}) => {
    ...
    let a = 'b';
        ...
        footerValue: 'WORKING'
                                ...
                                const part = new Part(partElt.id, now, place, footerContent, script, stateInit, trapsInit);
